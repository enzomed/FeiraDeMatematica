...
def textconfirmation():
    ...
    if textoconfirmacao == "Confirmar" or textoconfirmacao == 'confirmar':
        ...
        tk.messagebox.showerror('ERRO!','Por favor coloque o texto requisitado!')
...
for questao in lista:
    ...
    if questao == 2:
        ...
        if questao == ultimoitem:
            ...
            urlalternativa4 = urllib.request.urlopen('https://i.postimg.cc/0jNWszFJ/ex2-4-red.jpg')
