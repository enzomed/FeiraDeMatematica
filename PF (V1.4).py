...
for questao in lista:
    ...
    if questao == 8:
        ...
        if questao == ultimoitem:
            ...
            imagem_1 = Label(janelaultima, image=img_1)
            imagem_1.pack()
            frame_8= tk.Frame(master='janelaultima', highlightbackground="blue", highlightthickness=8, height=454, width=610)
            frame_8.pack(padx=10, pady=10)
            frame_8.place(x=379, y=0)
            button_8_1 = tk.Button(janelaultima, text='A) Sentido Anti-horário e 90°', command=perguntaerrada,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16)
                                )
            
            button_8_2 = tk.Button(janelaultima, text='B) Sentido Horário e 100°', command=perguntaerrada,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16)
                                )
            
            button_8_3 = tk.Button(janelaultima, text='C) Sentido Horário e 45°', command=janelaultima.destroy,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16)
                                )
            button_8_4 = tk.Button(janelaultima, text='D) Sentido Anti-horário e 60°', command=perguntaerrada,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16)
                                )
            button_8_1.pack()
            button_8_1.place(x=10, y=550)
            button_8_2.pack()
            button_8_2.place(x=383, y=550)
            button_8_3.pack()
            button_8_3.place(x=750, y=550)
            button_8_4.pack()
            button_8_4.place(x=1065, y=550)
            janelaultima.mainloop()
        else:
            janela8 = tk.Tk()
            ...
            frame_8= tk.Frame(master='janela8', highlightbackground="blue", highlightthickness=8, height=454, width=610)
            frame_8.pack(padx=10, pady=10)
            frame_8.place(x=379, y=0)
            button_8_1 = tk.Button(janela8, text='A) Sentido Anti-horário e 90°', command=perguntaerrada,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16) 
                                )
            button_8_2 = tk.Button(janela8, text='B) Sentido Horário e 100°', command=perguntaerrada,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16)
                                )
            button_8_3 = tk.Button(janela8, text='C) Sentido Horário e 45°', command=janela8.destroy,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16)
                                )
            button_8_4 = tk.Button(janela8, text='D) Sentido Anti-horário e 60°', command=perguntaerrada,
                                    background='#111111',
                                    foreground='white',
                                    font=('Bebas Neue', 16)
                                )
    ...
    if questao == 9:
        ...
        if questao == ultimoitem:
            ...
            button_1 = tk.Button(janelaultima, text='A) Uma translação.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_2 = tk.Button(janelaultima, text='B) Uma rotação em 180°.', command=janelaultima.destroy,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_3 = tk.Button(janelaultima, text='C) Reflexão no eixo X e rotação em 90°.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_4 = tk.Button(janelaultima, text='D) Uma rotação em 45°.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            ...
            button_1 = tk.Button(janela9, text='A) Uma translação.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_2 = tk.Button(janela9, text='B) Uma rotação em 180°.', command=janela9.destroy,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_3 = tk.Button(janela9, text='C) Reflexão no eixo X e rotação em 90°.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_4 = tk.Button(janela9, text='D) Uma rotação em 45°.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
    ...
    if questao == 10:
        ...
        def correcao():
            ...
            janelacorrecao.geometry('430x600')
            janelacorrecao.configure(background='#111111')
            urlimagemcorrecao1 = urllib.request.urlopen('https://i.postimg.cc/fR6w7Hr0/corre-transla-o-redimensionada.png')
            imgcorrecao1 = ImageTk.PhotoImage(file=urlimagemcorrecao1, master=janelacorrecao)
            imagemcorrecao1 = Label(janelacorrecao, image=imgcorrecao1)
            imagemcorrecao1.pack()
            janelacorrecao.mainloop()
        ...
        if questao == ultimoitem:
            ...
            janelaultima.geometry('1366x768')
            janelaultima.configure(background='#111111')
            frame_10= tk.Frame(master='janelaultima', highlightbackground="red", highlightthickness=8, height=454, width=610)
            frame_10.pack(padx=10, pady=10)
            frame_10.place(x=379, y=0)
            frame_10_1= tk.Frame(master='janelaultima', highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10_1.pack(padx=10, pady=10)
            frame_10_1.place(x=8, y=498 )
            frame_10_2= tk.Frame(master='janelaultima', highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10_2.pack(padx=10, pady=10)
            frame_10_2.place(x=298, y=498 )
            frame_10_3= tk.Frame(master='janelaultima', highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10_3.pack(padx=10, pady=10)
            frame_10_3.place(x=798, y=498 )
            frame_10_4= tk.Frame(master='janelaultima', highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10_4.pack(padx=10, pady=10)
            frame_10_4.place(x=1098, y=498 )
            ...
            frame_10=tk.Frame(master=janela10, highlightbackground="red", highlightthickness=8, height=455, width=610)
            frame_10.pack(padx=10, pady=10)
            frame_10.place(x=379, y=0)
            frame_10= tk.Frame(master=janela10, highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10.pack(padx=10, pady=10)
            frame_10.place(x=8, y=498 )
            frame_10_2= tk.Frame(master=janela10, highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10_2.pack(padx=10, pady=10)
            frame_10_2.place(x=298, y=498 )
            frame_10_3= tk.Frame(master=janela10, highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10_3.pack(padx=10, pady=10)
            frame_10_3.place(x=798, y=498 )
            frame_10_4= tk.Frame(master=janela10, highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_10_4.pack(padx=10, pady=10)
            frame_10_4.place(x=1098, y=498 )
            urlimagem_1 = urllib.request.urlopen('https://i.postimg.cc/9FXHmn9m/quest-exer10.png')
            urlalternativa10_1 = urllib.request.urlopen('https://i.postimg.cc/rmpG8HWr/ex10-1.png')
            ...
            button_10_2 = tk.Button(janela10, image=imgal2, command=janela10.destroy)
            button_10_3 = tk.Button(janela10, image=imgal3, command=perguntaerrada)
            button_10_4 = tk.Button(janela10, image=imgal4, command=perguntaerrada)
            button_10_1.pack()
            button_10_1.place(x=10, y=500)
            button_10_2.pack()
            button_10_2.place(x=300, y=500)
