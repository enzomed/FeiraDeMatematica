...
for questao in lista:
    if questao == 1:
        ...
        if questao == ultimoitem:
            ...
            button_2.pack()
            button_2.place(x=220, y=600)
            button_3.pack()
            button_3.place(x=1020, y=600)
            button_4.pack()
            button_4.place(x=1190, y=600)
            ...
            frame1 = tk.Frame(master=janela1, highlightbackground="purple", highlightthickness=8, height=45
                              , width=162)
            frame1.pack(padx=10, pady=10)
            frame1.place(x=48, y=598)

            frame2 = tk.Frame(master=janela1, highlightbackground="purple", highlightthickness=8, height=45
                              , width=162)
            frame2.pack(padx=10, pady=10)
            frame2.place(x=218, y=598)

            frame3 = tk.Frame(master=janela1, highlightbackground="purple", highlightthickness=8, height=45
                              , width=164)
            frame3.pack(padx=10, pady=10)
            frame3.place(x=1018, y=598)

            frame4 = tk.Frame(master=janela1, highlightbackground="purple", highlightthickness=8, height=45
                              , width=164)
            frame4.pack(padx=10, pady=10)
            frame4.place(x=1188, y=598)
    ...
    if questao == 3:
        ...
        if questao == ultimoitem:
            ...
            frame_3_1 = tk.Frame(master = janelaultima, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_1.pack(padx=10, pady=10)
            frame_3_1.place(x=48, y=448)
            frame_3_2 = tk.Frame(master = janelaultima, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_2.pack(padx=10, pady=10)
            frame_3_2.place(x=348, y=448)
            frame_3_3 = tk.Frame(master = janelaultima, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_3.pack(padx=10, pady=10)
            frame_3_3.place(x=698, y=448)
            frame_3_4 = tk.Frame(master = janelaultima, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_4.pack(padx=10, pady=10)
            frame_3_4.place(x=998, y=448)
            ...
            frame_3_1 = tk.Frame(master = janela3, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_1.pack(padx=10, pady=10)
            frame_3_1.place(x=48, y=448)
            frame_3_2 = tk.Frame(master = janela3, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_2.pack(padx=10, pady=10)
            frame_3_2.place(x=348, y=448)
            frame_3_3 = tk.Frame(master = janela3, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_3.pack(padx=10, pady=10)
            frame_3_3.place(x=698, y=448)
            frame_3_4 = tk.Frame(master = janela3, highlightbackground="orange", highlightthickness=8, height=160, width=260)
            frame_3_4.pack(padx=10, pady=10)
            frame_3_4.place(x=998, y=448)
    ...
    if questao == 7:
        ...
        if questao == ultimoitem:
            ...
            janelaultima.title('Última questão')
            janelaultima.configure(background='#111111')
            textointro = Label(janelaultima, text='Para formar um coração, a figura precisa:',
                                   background='#111111',
                                   foreground='white',
                                   font=('Bebas Neue', 18)
                                   )
            urlimagemenunciado = urllib.request.urlopen('https://i.postimg.cc/tCCPwLG1/ex-7.png')
            imgenunciado = ImageTk.PhotoImage(file=urlimagemenunciado, master=janelaultima)
            imagemenunciado = Label(janelaultima, image=imgenunciado)
            ...
            imagemenunciado = Label(janela7, image=imgenunciado)
    ...
    if questao == 8:
        ...
        if questao == ultimoitem:
            ...
            janelaultima.geometry('1366x768')
            janelaultima.configure(background='#111111')
            urlimagem_1 = urllib.request.urlopen('https://i.postimg.cc/m2SZV9YD/quest-exer8.png')
            frame1 = tk.Frame(master=janelaultima, highlightbackground="purple", highlightthickness=8, height=45
                              , width=162)
            frame1.pack(padx=10, pady=10)
            frame1.place(x=48, y=598)
            ...
            textoquestao = Label(janelaultima, text='A que corresponde a uma reflexão axial?',
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 20)
                                 )
            imagem_1.pack()
            button_1 = tk.Button(janelaultima, text='A) girou 45° no sentido anti-horario.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_2 = tk.Button(janelaultima, text='B) girou 90° no sentido horario.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_3 = tk.Button(janelaultima, text='C) girou 90° no sentido anti-horario.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_4 = tk.Button(janelaultima, text='D) girou 45° no sentido horario.', command=janelaultima.destroy,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            ...
            urlimagem_1 = urllib.request.urlopen('https://i.postimg.cc/m2SZV9YD/quest-exer8.png')
            img_1 = ImageTk.PhotoImage(file=urlimagem_1, master=janela8)
            imagem_1 = Label(janela8, image=img_1)

            frame1 = tk.Frame(master=janela8, highlightbackground="purple", highlightthickness=8, height=45
                              , width=162)
            frame1.pack(padx=10, pady=10)
            frame1.place(x=48, y=598)

            frame2 = tk.Frame(master=janela8, highlightbackground="purple", highlightthickness=8, height=45
                              , width=162)
            frame2.pack(padx=10, pady=10)
            frame2.place(x=218, y=598)

            frame3 = tk.Frame(master=janela8, highlightbackground="purple", highlightthickness=8, height=45
                              , width=164)
            frame3.pack(padx=10, pady=10)
            frame3.place(x=1018, y=598)

            frame4 = tk.Frame(master=janela8, highlightbackground="purple", highlightthickness=8, height=45
                              , width=164)
            frame4.pack(padx=10, pady=10)
            frame4.place(x=1188, y=598)

            textoquestao = Label(janela8, text='A que corresponde a uma reflexão axial?',
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 20)
                                 )
            imagem_1.pack()
            button_1 = tk.Button(janela8, text='A) girou 45° no sentido anti-horario.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_2 = tk.Button(janela8, text='B) girou 90° no sentido horario.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_3 = tk.Button(janela8, text='C) girou 90° no sentido anti-horario.', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            button_4 = tk.Button(janela8, text='D) girou 45° no sentido horario.', command=janela8.destroy,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 16)
                                 )
            ...
            button_3.pack()
            button_3.place(x=900, y=540)
            button_4.pack()
            button_4.place(x=900, y=600)
            janela8.mainloop()
    ...
    if questao == 9:
        ...
        if questao == ultimoitem:
            ...
            urlalternativa9_1 = urllib.request.urlopen('https://i.postimg.cc/zDwqCGJ8/ex2-1-red.png')
            urlalternativa9_2 = urllib.request.urlopen('https://i.postimg.cc/dVGxZLRK/ex2-2-red.png')
            urlalternativa9_3 = urllib.request.urlopen('https://i.postimg.cc/Vk9KL21f/ex2-3-red.png')
            urlalternativa9_4 = urllib.request.urlopen('https://i.postimg.cc/W3ynHvmn/ex2-4-red.png')
            img_1 = ImageTk.PhotoImage(file=urlimagem_1, master=janelaultima)
            imgal1 = ImageTk.PhotoImage(file=urlalternativa9_1, master=janelaultima)
            imgal2 = ImageTk.PhotoImage(file=urlalternativa9_2, master=janelaultima)
            imgal3 = ImageTk.PhotoImage(file=urlalternativa9_3, master=janelaultima)
            imgal4 = ImageTk.PhotoImage(file=urlalternativa9_4, master=janelaultima)
            imagem_1 = Label(janelaultima, image=img_1)
            imagem_1.pack()
            button_9_1 = tk.Button(janelaultima, image=imgal1, command=perguntaerrada)
            button_9_2 = tk.Button(janelaultima, image=imgal2, command=perguntaerrada)
            button_9_3 = tk.Button(janelaultima, image=imgal3, command=perguntaerrada)
            button_9_4 = tk.Button(janelaultima, image=imgal4, command=janelaultima.destroy)
            button_9_1.pack()
            button_9_1.place(x=10, y=500)
            button_9_2.pack()
            button_9_2.place(x=300, y=500)
            button_9_3.pack()
            button_9_3.place(x=800, y=500)
            button_9_4.pack()
            button_9_4.place(x=1100, y=500)
            janelaultima.mainloop()
        else:
            janela9 = tk.Tk()
            ...
            imgal1 = ImageTk.PhotoImage(file=urlalternativa9_1, master=janela9)
            imgal2 = ImageTk.PhotoImage(file=urlalternativa9_2, master=janela9)
            imgal3 = ImageTk.PhotoImage(file=urlalternativa9_3, master=janela9)
            imgal4 = ImageTk.PhotoImage(file=urlalternativa9_4, master=janela9)
            imagem_1 = Label(janela9, image=img_1)
            imagem_1.pack()
            button_9_1 = tk.Button(janela9, image=imgal1, command=perguntaerrada)
            button_9_2 = tk.Button(janela9, image=imgal2, command=perguntaerrada)
            button_9_3 = tk.Button(janela9, image=imgal3, command=perguntaerrada)
            button_9_4 = tk.Button(janela9, image=imgal4, command=janela9.destroy)
            button_9_1.pack()
            button_9_1.place(x=10, y=500)
            button_9_2.pack()
            button_9_2.place(x=300, y=500)
    ...
    if questao == 10:
        ...
        if questao == ultimoitem:
            ...
            janelaultima.geometry('1366x768')
            janelaultima.configure(background='#111111')
            urlimagem_1 = urllib.request.urlopen('https://i.postimg.cc/9FXHmn9m/quest-exer10.png')
            urlalternativa10_1 = urllib.request.urlopen('https://i.postimg.cc/zDwqCGJ8/ex2-1-red.png')
            urlalternativa10_2 = urllib.request.urlopen('https://i.postimg.cc/dVGxZLRK/ex2-2-red.png')
            urlalternativa10_3 = urllib.request.urlopen('https://i.postimg.cc/Vk9KL21f/ex2-3-red.png')
            urlalternativa10_4 = urllib.request.urlopen('https://i.postimg.cc/W3ynHvmn/ex2-4-red.png')
            img_1 = ImageTk.PhotoImage(file=urlimagem_1, master=janelaultima)
            ...
            imagem_1 = Label(janelaultima, image=img_1)
            imagem_1.pack()
            button_10_1 = tk.Button(janelaultima, image=imgal1, command=perguntaerrada)
            button_10_2 = tk.Button(janelaultima, image=imgal2, command=perguntaerrada)
            button_10_3 = tk.Button(janelaultima, image=imgal3, command=perguntaerrada)
            button_10_4 = tk.Button(janelaultima, image=imgal4, command=janelaultima.destroy)
            button_10_1.pack()
            button_10_1.place(x=10, y=500)
            button_10_2.pack()
            button_10_2.place(x=300, y=500)
            button_10_3.pack()
            button_10_3.place(x=800, y=500)
            button_10_4.pack()
            button_10_4.place(x=1100, y=500)
            janelaultima.mainloop()
        else:
            janela10 = tk.Tk()
            ...
            urlalternativa10_3 = urllib.request.urlopen('https://i.postimg.cc/Vk9KL21f/ex2-3-red.png')
            urlalternativa10_4 = urllib.request.urlopen('https://i.postimg.cc/W3ynHvmn/ex2-4-red.png')
            img_1 = ImageTk.PhotoImage(file=urlimagem_1, master=janela10)
            ...
            imagem_1 = Label(janela10, image=img_1)
            imagem_1.pack()
            button_10_1 = tk.Button(janela10, image=imgal1, command=perguntaerrada)
            button_10_2 = tk.Button(janela10, image=imgal2, command=perguntaerrada)
            button_10_3 = tk.Button(janela10, image=imgal3, command=perguntaerrada)
            button_10_4 = tk.Button(janela10, image=imgal4, command=janela10.destroy)
            button_10_1.pack()
            button_10_1.place(x=10, y=500)
            button_10_2.pack()
            button_10_2.place(x=300, y=500)
