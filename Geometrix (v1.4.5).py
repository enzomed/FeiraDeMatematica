...
botaoinicio.pack(pady=5)
botaocreditos.pack(pady=5)
botaoencerrar.pack(pady=5)
...
for questao in lista:
    ...
    if questao == 8:
        ...
        if questao == ultimoitem:
            ...
            button_8_3.pack()
            button_8_3.place(x=794, y=554)
            button_8_4_1.pack()
            button_8_4_1.place(x=1100, y=550)
            button_8_4.pack()
            button_8_4.place(x=1104, y=554)
            janela8.mainloop()
    ...
    if questao == 9:
        ...
        if questao == ultimoitem:
            ...
            frame1 = tk.Frame(master=janelaultima, highlightbackground="purple", highlightthickness=8, height=50
                              , width=180)
            frame1.pack(padx=10, pady=10)
            frame1.place(x=48, y=598)

            frame2 = tk.Frame(master=janelaultima, highlightbackground="purple", highlightthickness=8, height=50
                              , width=147)
            frame2.pack(padx=10, pady=10)
            frame2.place(x=48, y=538)

            frame3 = tk.Frame(master=janelaultima, highlightbackground="purple", highlightthickness=8, height=50
                              , width=285) ## Alternativa C
            frame3.pack(padx=10, pady=10)
            frame3.place(x=1062, y=538)

            frame4 = tk.Frame(master=janelaultima, highlightbackground="purple", highlightthickness=8, height=50
                              , width=175) ## Alternativa D
            frame4.pack(padx=10, pady=10)
            ...
            frame10.place(x=379, y=0)
            urlimagem_1 = urllib.request.urlopen('https://i.postimg.cc/cCSZB16w/quest-exer9.png')
            frame1 = tk.Frame(master=janela9, highlightbackground="purple", highlightthickness=8, height=50
                              , width=180)
            frame1.pack(padx=10, pady=10)
            frame1.place(x=48, y=598)

            frame2 = tk.Frame(master=janela9, highlightbackground="purple", highlightthickness=8, height=50
                              , width=147)
            frame2.pack(padx=10, pady=10)
            frame2.place(x=48, y=538)

            frame3 = tk.Frame(master=janela9, highlightbackground="purple", highlightthickness=8, height=50
                              , width=285)
            frame3.pack(padx=10, pady=10)
            frame3.place(x=1062, y=538)

            frame4 = tk.Frame(master=janela9, highlightbackground="purple", highlightthickness=8, height=50
                              , width=175)
            frame4.pack(padx=10, pady=10)
            frame4.place(x=1081, y=598)
