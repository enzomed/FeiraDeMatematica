...
for questao in lista:
    ...
    if questao == 4:
        ...
        def answer():
            if strresposta1 == 'Reflexão' or strresposta1 == 'reflexão':
                janelacorreta = tk.Tk()
                janelacorreta.geometry('800x800')
                janelacorreta.title('Você está certo!')
                texto = Label(janelacorreta, text='Você está correto!',
                              background='#111111',
                              foreground='white',
                              font=('Bebas Neue', 18)
                              )
                texto.pack()
                janelacorreta.mainloop()
            else:
                perguntaerrada()
        ...
        if questao == ultimoitem:
            ...
            textoquestao4 = Label(janela4, text='Relacione a imagem com sua respectiva transformação.',
                                  background='#111111',
                                  foreground='white',
                                  font=('Bebas Neue', 20)
                                  )
            textoinsres = Label(janela4, text='Insira sua resposta:',
                                background='#111111',
                                foreground='white',
                                font=('Bebas Neue', 18)
                                )
            urlalternativa1 = urllib.request.urlopen('https://i.postimg.cc/MGmJ34Jc/ex3-1-red.png')
            imgal1 = ImageTk.PhotoImage(file=urlalternativa1, master=janela4)
            imagemal1 = Label(janela4, image=imgal1)
            imagemal1.pack()
            resposta1 = tk.Entry(janela4, text='Insira sua resposta')
            resposta1.pack()
            buttonresposta = tk.Button(janela4, text='Enter', command=answer)
            buttonresposta.pack()
            janela4.mainloop()
