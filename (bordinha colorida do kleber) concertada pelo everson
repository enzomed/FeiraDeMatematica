...
for questao in lista:
    ...
    if questao == 2:
        ...
        def correcao():
            ...
            urlimagemcorrecao2 = urllib.request.urlopen('https://i.postimg.cc/MKC1wdJm/corre-reflex-o-redimensionada.png')
    ...
    if questao == 3:
        ...
        if questao == ultimoitem:
            ...
            frame_3_1 = tk.Frame(master = janela3, highlightbackground="purple", highlightthickness=8, height=160, width=260)
            ...
            frame_3_3 = tk.Frame(master = janela3, highlightbackground="red", highlightthickness=8, height=160, width=260)
            frame_3_3.pack(padx=10, pady=10)
            frame_3_3.place(x=698, y=448)
            frame_3_1 = tk.Frame(master = janela3, highlightbackground="blue", highlightthickness=8, height=160, width=260)
            frame_3_1.pack(padx=10, pady=10)
            frame_3_1.place(x=998, y=448)
            urlimagem_1 = urllib.request.urlopen('https://i.postimg.cc/cCGbmzq6/quest-exer4.png')
            urlalternativa1 = urllib.request.urlopen('https://i.postimg.cc/0jyYGGth/ex4-1-red.png')
            urlalternativa2 = urllib.request.urlopen('https://i.postimg.cc/kGcDMkqb/ex4-2-red.png')
            urlalternativa3 = urllib.request.urlopen('https://i.postimg.cc/TwsC7HZn/ex4-3-red.png')
