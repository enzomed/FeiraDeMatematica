...
for questao in lista:
    if questao == 1:
        ...
        if questao == ultimoitem:
            ...
            imagem_1.pack()
            button_1 = tk.Button(janela1, text='A)  Alternativa A', command=janela1.destroy,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue',12)
                                 )
            button_2 = tk.Button(janela1, text='B)  Alternativa B', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue',12)
                                 )
            button_3 = tk.Button(janela1, text='C)  Alternativa C', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue',12)
                                 )
            button_4 = tk.Button(janela1, text='D)  Alternativa D', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue',12)
                                 )
            button_5 = tk.Button(janela1, text='E)  Alternativa E', command=perguntaerrada,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue',12)
                                 )
