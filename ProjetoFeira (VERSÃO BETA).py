...
imagemprincipal = cv2.imread('C:/Users/Nathaen/Downloads/mathchalkboard.webp')
im = Image.fromarray(imagemprincipal)
...
def pergunta1():
    ...
    imagem1 = ImageTk.PhotoImage(file='C:/Users/Nathaen/Downloads/Trollface.png',master=janela1)
    lbimagem1 = Label(janela1, image=imagem1)
    lbimagem1.pack()
...
def pergunta2():
    ...
    imagem2 = ImageTk.PhotoImage(file='C:/Users/Nathaen/Downloads/memeface1.png',master=janela2)
    lbimagem2 = Label(janela2, image=imagem2)
    lbimagem2.pack()
...
def pergunta3():
    ...
    imagem3 = ImageTk.PhotoImage(file='C:/Users/Nathaen/Downloads/rockmanx.jpg',master=janela3)
    lbimagem3 = Label(janela3, image=imagem3)
    lbimagem3.pack()
...
def creditos():
    ...
    imagemcolaboradores = Image.open('C:/Users/Nathaen/Downloads/grupo.jpeg')
    imagemtam = imagemcolaboradores.resize((1080,600))
    imagemgrupo = ImageTk.PhotoImage(imagemtam,master=janelacreditos)
    label = Label(janelacreditos,image=imagemgrupo)
    textocreditos.pack()
    textocreditos1.pack()
    label.pack()
