...
botaotutorial = tk.Button(janela_principal, text='Clique para abrir o Tutorial.',
                          ...
                          foreground="white",
                          font=("Bebas Neue", 17),
                          command=play_youtubevideo_from_browser, bd=5)
...
botaotutorial.pack()
botaotutorial.place(x=1038, y=558)
...
def textconfirmation():
    ...
    if textoconfirmacao == "Confirmar" or textoconfirmacao == 'confirmar':
        ...
        errorlabel = tk.Label(errorpopup,text='Por favor, digite corretamente o texto requisitado!',background="#111111",
                              foreground='white',font=('Bebas Neue',15))
        errorlabel.pack()
        errorpopup.mainloop()
...
confirmbutton = tk.Button(janelaregra,text='Enter',background="#111111",foreground='white',font=('Bebas Neue',15),command=textconfirmation)
aviso = Label(janelaregra,text='LEIA ATENTAMENTE AS REGRAS!',background='#111111',foreground='white',font=('Bebas Neue',20))
...
\n 2) Ao se deparar com perguntas em que exigem uma resposta escrita do usuário,
      ...
      acentuações gráficas e os sinais de pontuação!''',background="#111111",foreground='white',font=('Bebas Neue',16))
...
for questao in lista:
    ...
    if questao == 5:
        ...
        if questao == ultimoitem:
            ...
            textoquestao.pack(pady=10)
            imagemalternativa5.pack()
            resposta1.pack()
            resposta1.place(x=618, y=525)
            buttonenter_5.pack()
            buttonenter_5.place(x=642, y=558)
            buttonenter.pack()
            buttonenter.place(x=644, y=560)
            janelaultima.mainloop()
    ...
    if questao == 6:
        ...
        if questao == ultimoitem:
            ...
            resposta.pack()
            resposta.place(x=618, y=525)
            buttonenter.pack()
            buttonenter.place(x=644, y=560)
            buttonenter_1.pack()
            buttonenter_1.place(x=642, y=558)
            janelaultima.mainloop()
        else:
            janela6 = tk.Tk()
    ...
    if questao == 7:
        ...
        if questao == ultimoitem:
            ...
            button_4 = tk.Button(janelaultima, text='D) Sofrer uma reflexão no eixo y.',
                                 ...
                                 font=('Bebas Neue', 18),
                                 command=perguntaacerto7)
            imagemenunciado.pack(pady=20)
            button_1.pack()
            button_1_7.pack()
            button_1.place(x=274, y=514)
            button_1_7.place(x=270, y=510)
            button_2.pack()
            button_2_7.pack()
            ...
            button_3.pack()
            button_3_7.pack()
            button_3.place(x=804, y=514)
            button_3_7.place(x=800, y=510)
            button_4.pack()
            button_4_7.pack()
    ...
    if questao == 8:
        ...
        if questao == ultimoitem:
            ...
            button_8_1_1.pack()
            button_8_1_1.place(x=80, y=550)
            button_8_1.pack()
            button_8_1.place(x=84, y=554)
            button_8_2_1.pack()
            button_8_2_1.place(x=383, y=550)
            button_8_2.pack()
            button_8_2.place(x=387, y=554)
            button_8_3_1.pack()
            button_8_3_1.place(x=796, y=550)
            button_8_3.pack()
            button_8_3.place(x=800, y=554)
            button_8_4_1.pack()
    ...
    if questao == 9:
        ...
        if questao == ultimoitem:
            ...
            img_1 = ImageTk.PhotoImage(file=urlimagem_1, master=janelaultima)
            imagem_1 = Button(janelaultima, image=img_1, background='purple', border=7)
            imagem_1.pack(pady=25)

            button_9_1_1 = tk.Button(janelaultima, text='A) Uma translação.', command=perguntaerrada9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_1 = tk.Button(janelaultima, text='A) Uma translação.', command=perguntaerrada9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
            
            button_9_2_1 = tk.Button(janelaultima, text='B) Uma rotação em 180°.', command=perguntaacerto9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_2 = tk.Button(janelaultima, text='B) Uma rotação em 180°.', command=perguntaacerto9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
            
            button_9_3_1 = tk.Button(janelaultima, text='C) Reflexão no eixo X.', command=perguntaerrada9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_3 = tk.Button(janelaultima, text='C) Reflexão no eixo X.', command=perguntaerrada9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
            
            button_9_4_1 = tk.Button(janelaultima, text='D) Uma rotação em 45°.', command=perguntaerrada9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_4 = tk.Button(janelaultima, text='D) Uma rotação em 45°.', command=perguntaerrada9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
            ...
            button_9_1.pack()
            button_9_1.place(x=314, y=519)
            button_9_1_1.pack()
            button_9_1_1.place(x=310, y=515)
            button_9_2.pack()
            button_9_2.place(x=844, y=519)
            button_9_2_1.pack()
            button_9_2_1.place(x=840, y=515)
            button_9_3.pack()
            button_9_3.place(x=314, y=604)
            button_9_3_1.pack()
            button_9_3_1.place(x=310, y=600)
            button_9_4.pack()
            button_9_4.place(x=844, y=604)
            button_9_4_1.pack()
            button_9_4_1.place(x=840, y=600)
            janelaultima.mainloop()
            ...
            imagem_1 = Button(janela9, image=img_1, background='purple', border=7)
            imagem_1.pack(pady=25)

            button_9_1_1 = tk.Button(janela9, text='A) Uma translação.', command=perguntaerrada9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_1 = tk.Button(janela9, text='A) Uma translação.', command=perguntaerrada9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
            
            button_9_2_1 = tk.Button(janela9, text='B) Uma rotação em 180°.', command=perguntaacerto9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_2 = tk.Button(janela9, text='B) Uma rotação em 180°.', command=perguntaacerto9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
            
            button_9_3_1 = tk.Button(janela9, text='C) Reflexão no eixo X.', command=perguntaerrada9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_3 = tk.Button(janela9, text='C) Reflexão no eixo X.', command=perguntaerrada9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
            
            button_9_4_1 = tk.Button(janela9, text='D) Uma rotação em 45°.', command=perguntaerrada9,
                                 background='purple',
                                 foreground='white',
                                 font=('Bebas Neue', 18), bd=7
                                 )
            button_9_4 = tk.Button(janela9, text='D) Uma rotação em 45°.', command=perguntaerrada9,
                                 background='#111111',
                                 foreground='white',
                                 font=('Bebas Neue', 18)
                                 )
    ...
    if questao == 10:
        ...
        if questao == ultimoitem:
            ...
            frame_10 = tk.Frame(master=janelaultima, highlightbackground="red", highlightthickness=8, height=460,
                                width=610)
            frame_10.pack(padx=10, pady=10)
            frame_10.place(x=379, y=17)
            imagem_10 = Label(janelaultima, image=img_10)
            imagem_10.pack(pady=20)
            ...
            frame_10 = tk.Frame(master=janela10, highlightbackground="red", highlightthickness=8, height=460, width=610)
            frame_10.pack(padx=10, pady=10)
            frame_10.place(x=379, y=17)
